...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style>
        ...
        .logo-secondary-circle {
            fill: #D92228; /* Red accent */
            stroke: #FFFFFF;
            stroke-width: 1;
        }
        .logo-text {
    ...
    <div class="team-header">
        <div class="logo-container">
            ...
            <svg class="simple-logo" viewBox="0 0 100 100">
                ...
                <circle class="logo-secondary-circle" cx="50" cy="25" r="10" />
                <text class="logo-text" x="50" y="45" text-anchor="middle" font-size="14">הפועל</text>
                <text class="logo-text" x="50" y="65" text-anchor="middle" font-size="14">פתח תקווה</text>
            </svg>
        </div>
