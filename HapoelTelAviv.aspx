    ...
    <div class="team-header">
        <div class="logo-container">
            ...
            <svg class="simple-logo" viewBox="0 0 100 100">
                ...
                <text class="logo-text" x="50" y="45" text-anchor="middle" font-size="16">הפועל</text>
                <text class="logo-text" x="50" y="65" text-anchor="middle" font-size="16">תל אביב</text>
            </svg>
        </div>
